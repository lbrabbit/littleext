...
const hostbanner="由<A HREF='http://rt.openfoundry.org/Foundry/'><img src='http://littleext.openfoundry.org/OSSF.gif' border='0' title='自由軟體鑄造場'></A>提供網上空間";
const hostphpbbbanner="由[url=http://rt.openfoundry.org/Foundry/]自由軟體鑄造場[/url]提供網上空間";
...
function addcredit(formText,instring,banner,hostb,br) {
  var bodyText;
  var credit;
  var bodyLen;  
